...
mvn install:install-file -Dfile=../lib/wsi-checker-1.1.0.jar -DgroupId=pfrandsen -DartifactId=wsi-checker -Dversion=1.1.0 -Dpackaging=jar -DlocalRepositoryPath=.
